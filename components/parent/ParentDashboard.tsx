    ...
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="text-center">
          ...
          <h2 className="text-xl font-semibold text-gray-700">No Children Found</h2>
          <p className="text-gray-500 mt-2">Add a child to start tracking their progress.</p>
        </div>
      </div>
    );
  }
        ...
        <div className="max-w-7xl mx-auto px-4 py-4">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-sm text-gray-500">Track your child's Montessori journey</p>
            </div>
            <ChildSwitcher
              children={children}
