...
// First-login welcome banner. Soft emerald-tinted card with emerald text —
// matches the Sanctuary banner style (the original founder banner), full-width,
// shown ONCE to a verified public coach user the first time they land, then
...
export default function WelcomeBanner() {
  ...
  return (
    ...
    >
      ...
      <span aria-hidden style={{ opacity: 0.65, fontSize: 16, flexShrink: 0 }}>×</span>
    </button>
  );
}
