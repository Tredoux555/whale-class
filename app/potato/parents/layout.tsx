// app/potato/parents/layout.tsx
// PWA install metadata for the parent side only: manifest link, icons, and
...
export const metadata: Metadata = {
  title: 'Potato Snaps — Parents',
  manifest: '/potato-parents/manifest.json',
  appleWebApp: {
    capable: true,
...
export default function PotatoParentsLayout({ children }: { children: React.ReactNode }) {
  return children;
}
