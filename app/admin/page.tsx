...
<Link
          ...
          <Link
            href="/admin/parent-signups"
            prefetch={false}
            className="bg-gradient-to-r from-orange-500 to-amber-600 text-white px-6 py-3 rounded-lg font-semibold hover:from-orange-600 hover:to-amber-700 transition-all shadow-md flex items-center gap-2"
          >
            <span className="text-xl">📝</span> Parent Signups
          </Link>
            <Link
