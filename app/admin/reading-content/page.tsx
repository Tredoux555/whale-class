...
export default function ReadingContentPage() {
  useEffect(() => {
    window.location.replace('/whale-reading-content.html');
  }, []);
  ...
  return (
    <div style={{
      ...
      <div style={{ textAlign: 'center' }}>
        ...
        <div style={{ fontSize: 18, marginBottom: 8 }}>Opening Pink Phase lesson content…</div>
        <div style={{ fontSize: 13, color: '#888', marginBottom: 16 }}>If this doesn&rsquo;t redirect automatically:</div>
        <a
          href="/whale-reading-content.html"
          style={{
            color: '#e91e63',
