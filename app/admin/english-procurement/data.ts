import type { ExtensionDetail, ShelfData, AssessmentSkill, GrammarSymbol, Category } from './types';

// =============================================================================
// CVC WORD FAMILIES
// =============================================================================

export const cvcWordFamilies: Record<string, string[]> = {
  // Short A families
...
export const phonogramData: Record<string, { sound: string; position: string; examples: string[] }> = {
...
export const grammarSymbols: GrammarSymbol[] = [
  { part: 'NOUN', shape: 'Large triangle', color: 'Black', meaning: 'Naming words (person, place, thing)' },
  { part: 'ARTICLE', shape: 'Small triangle', color: 'Light Blue', meaning: 'A, An, The' },
  { part: 'ADJECTIVE', shape: 'Medium triangle', color: 'Dark Blue', meaning: 'Describing words' },
  { part: 'VERB', shape: 'Circle', color: 'Red', meaning: 'Action words' },
  { part: 'ADVERB', shape: 'Small circle', color: 'Orange', meaning: 'Words that modify verbs' },
  { part: 'PREPOSITION', shape: 'Crescent', color: 'Green', meaning: 'Position words (in, on, under, etc.)' },
  { part: 'PRONOUN', shape: 'Purple triangle', color: 'Purple', meaning: 'Words that replace nouns (I, he, she, it, etc.)' },
  { part: 'CONJUNCTION', shape: 'Rectangle', color: 'Pink', meaning: 'Connector words (and, but, or, because)' },
...
// NOTE: The detailed shelf organization (detailedShelfOrganization) and curriculum data (curriculumData)
// are still defined in page.tsx due to their massive size (3000+ lines).
// Future refactoring should move these to this file or a separate curriculum-data.ts file.
// For now, they are imported via the Component's internal state to avoid circular dependencies.

export const assessmentChecklist: Record<string, AssessmentSkill[]> = {
  'Oral Language': [
...
export const extensionDetails: Record<string, ExtensionDetail> = {
...
export const initialSoundObjects: Record<string, string[]> = {
...
// =============================================================================
// DETAILED SHELF ORGANIZATION
// =============================================================================

export const detailedShelfOrganization: ShelfData[] = [
  {
