...
const SECTIONS = [
  {
    title: '⚡ INTELLIGENCE',
    tools: [
      { name: 'Demo Requests', desc: 'Action list — landing page demo requests, contact status, follow-up tracking', href: '/montree/super-admin/marketing/demo-requests', icon: '🔔', featured: true },
      { name: 'Outreach Hub', desc: 'Live CRM — multiplier partners + school outreach pipeline, bounce tracking, daily sends', href: '/montree/super-admin/marketing/outreach-hub', icon: '🎯', featured: true },
      { name: 'Campaign Manager', desc: 'Draft → review → send workflow. Claude drafts, you send from Gmail.', href: '/montree/super-admin/marketing/campaign-manager', icon: '📮', featured: true },
      { name: 'Master Campaign', desc: '1,135 schools · 507 MX-verified', href: '/montree/super-admin/marketing/master-campaign', icon: '📊', featured: true },
  ...
  },
  {
    ...
    tools: [
      ...
      { name: 'Outreach Campaign (Legacy)', desc: 'Old static Tier-S targets — replaced by Campaign Manager', href: '/montree/super-admin/marketing/outreach-campaign', icon: '📝' },
