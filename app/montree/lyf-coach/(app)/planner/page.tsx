...
// add_event.
//
// PUBLIC carbon copy of the Sanctuary planner: the covert Messages door behind
// the month title (SecretGate) is REMOVED here, and the "Plan my day / week"
// links point at the public coach route.
    ...
    <div>
      ...
      <div style={{ ...cardStyle, padding: 16, marginBottom: 18 }}>
        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: 12 }}>
          ...
          {/* Month title — plain label (no covert door in the public build). */}
