// app/montree/library/tools/classroom-jobs/page.tsx
// Thin redirect — the Classroom Jobs Poster now lives as the "Jobs poster"
// tab of the merged Classroom Helpers tool. This route stays alive so old
// bookmarks and links keep working; its actual body moved to
// components/montree/tools/ClassroomJobsTool.tsx (mounted from
...
export default function ClassroomJobsRedirect() {
  const router = useRouter();

  useEffect(() => {
    router.replace('/montree/library/tools/classroom-helpers?tab=poster');
  }, [router]);
