...
import TeachersRoom from '@/components/montree/satpin/TeachersRoom';
    ...
    <div className="min-h-screen relative overflow-hidden flex flex-col" style={{ background: '#06140e' }}>
      ...
      <div className="relative z-10 flex-1 flex justify-center px-6 pb-8">
        <div className="max-w-3xl w-full text-center">
          ...
          {/* Community — public board + shared-materials drop box.
              Reading is anonymous; posting/uploading needs a confirmed
              Teachers' Room account (its own login, no school attached). */}
          <TeachersRoom />
