        ...
        <>
          <div className={`${CARD} mt-4`}>
            ...
            {s.map_suppressed || s.map_percent === null ? (
              <>
                <p className="font-serif text-xl text-forest-muted">Not reported</p>
                <p className="mt-1.5 text-[12.5px] leading-relaxed text-forest-muted">
                  ...
                  The bands below still stand on their own.
                </p>
              </>
            ) : (
              <div className="flex items-baseline gap-2.5">
                <span className="font-serif text-4xl text-emerald-primary">{s.map_percent}%</span>
                <span className="text-[12.5px] text-forest-muted">
          ...
          {s.efl_map_denominator ? (
            <div className={`${CARD} mt-3`}>
              ...
              {s.efl_map_suppressed || s.efl_map_percent === null ? (
                <p className="font-serif text-lg text-forest-muted">Not reported</p>
              ) : (
                <div className="flex items-baseline gap-2.5">
                  <span className="font-serif text-3xl text-forest-gold">{s.efl_map_percent}%</span>
                  <span className="text-[12.5px] text-forest-muted">
