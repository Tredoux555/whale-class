...
//
// AUTH: principal-only. Session 114 dropped the Tredoux-userId hard gate;
// every authenticated principal can transcribe. AI tier gate stays — vault
// transcription requires a paid AI tier (Sonnet for the summary).
