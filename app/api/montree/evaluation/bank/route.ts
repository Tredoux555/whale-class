 ...
 */
import { badRequest, json, openRoute, serverError } from '@/lib/montree/evaluation/route-helpers';
import { projectBank } from '@/lib/montree/evaluation/bank-projection';
import { ALL_MODULE_IDS } from '@/lib/montree/evaluation/constants';
import type { AgeBand, FormCode } from '@/lib/montree/evaluation/types';

export const dynamic = 'force-dynamic';
export const maxDuration = 30;

const AGE_BANDS: readonly string[] = ['A3', 'A4', 'A5'];
...
export async function GET(request: Request): Promise<Response> {
  ...
  if (!AGE_BANDS.includes(ageBand)) return badRequest('invalid_age_band', 'expected A3, A4 or A5');
