  ...
  practical_life: [
    {
      ...
      game_url: '/montree/dashboard/games/sensorial-sort',
      game_icon: '🎨',
  ...
  sensorial: [
    {
      ...
      game_url: '/montree/dashboard/games/color-match',
      game_icon: '🎨',
    ...
    },
    {
      ...
      game_url: '/montree/dashboard/games/color-grade',
      game_icon: '🌈',
  ...
  mathematics: [
    {
      ...
      game_url: '/montree/dashboard/games/number-tracer',
      game_icon: '✏️',
    ...
    },
    {
      ...
      game_url: '/montree/dashboard/games/quantity-match',
      game_icon: '🔢',
    ...
    },
    {
      ...
      game_url: '/montree/dashboard/games/bead-frame',
      game_icon: '🧮',
  ...
  language: [
    {
      ...
      game_url: '/montree/dashboard/games/letter-sounds',
      game_icon: '🔤',
    ...
    },
    {
      ...
      game_url: '/montree/dashboard/games/word-builder',
      game_icon: '📝',
    ...
    },
    {
      ...
      game_url: '/montree/dashboard/games/letter-tracer',
      game_icon: '✏️',
  ...
  cultural: [
    {
      ...
      game_url: '/montree/dashboard/games/match-attack',
      game_icon: '🧠',
