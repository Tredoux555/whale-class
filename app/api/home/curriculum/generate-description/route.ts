// /api/home/curriculum/generate-description/route.ts
// POST - Generate parent-friendly descriptions for home curriculum works
...
const descriptionTemplates = {
  practical_life: {
    descriptions: [
      ...
      `Through {work_name}, your child is discovering their ability to contribute meaningfully to daily life. This activity builds hand-eye coordination, patience, and the joy that comes from completing real, purposeful work that matters in your home.`,
    ],
    why_it_matters: [
      ...
      `Practical life activities develop the fine motor control and concentration needed for writing, math, and other academic skills. More importantly, they build self-esteem and a sense of contribution to the family.`,
