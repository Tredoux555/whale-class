...
export const metadata: Metadata = {
  title: 'Privacy Policy — Lyf Coach',
  description:
    'How Lyf Coach protects your data. Your journal, planner, projects, and coach history are encrypted on your device — we store only ciphertext we cannot read.',
};
...
export default function LyfCoachPrivacyPage() {
  return (
    <main
      style={{
        maxWidth: 760,
    ...
    >
      <h1 style={{ fontSize: 30, fontWeight: 700, color: '#0B2D2A', margin: 0 }}>Lyf Coach — Privacy Policy</h1>
      ...
      <Section title="Contact">
        ...
        <a href="mailto:privacy@montree.xyz" style={{ color: '#0F6E56' }}>privacy@montree.xyz</a>.
      </Section>
    </main>
  );
}
