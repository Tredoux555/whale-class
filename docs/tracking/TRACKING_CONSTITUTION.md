...
7. SEQUENCE IS DATA. Every work has a position (curriculum sequence). "Next" = computed from position + status. Letter mastered = its 5 works mastered. Gaps flagged, never filled.
