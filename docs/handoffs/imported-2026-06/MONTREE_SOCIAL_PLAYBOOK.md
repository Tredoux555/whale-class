...
## HOW TO DRIVE THIS (the command + the protocol)

Say to WebClaude, e.g.:

> **"Upload video 1 — guru to all the relevant social media sites."**

WebClaude then does **Step A** (open tabs). Because the platforms block automated file-attach and we never want a surprise auto-post, you then drop the video file into each tab and say:

> **"Take the next step."**

WebClaude then does **Step B** (paste caption + hashtags + title where each platform needs them) and **stops at the final review screen on every tab. It never clicks Post / Share / Publish — you do that.**

### Step A — open the upload tabs (one per platform)
1. Instagram — https://www.instagram.com/ → "+" → **Reel**
2. Facebook — https://www.facebook.com/ → **Reels → Create reel**
3. TikTok — https://www.tiktok.com/upload
4. X — https://x.com/compose/post
5. LinkedIn — https://www.linkedin.com/feed/ → **Start a post → video**
6. YouTube — https://studio.youtube.com/ → **Create → Upload videos** (mark as **Short**; vertical 9:16 under 3 min auto-qualifies)

### Step B — for each tab
- Confirm the video is attached (you dropped it in).
...
> Honest limits (so nothing silently fails): WebClaude **can** open tabs and fill text. It usually **cannot** attach the local video file for you (you drop it) and must **never** hit Post. Treat it as "everything filled, you review and publish."

---

## POSTING SEQUENCE (daily, in this order)

| Day | # | Video | One-line angle |
|----|----|----|----|
| 1 | 1 | **guru** | A Montessori guru for every child — trained on real classroom records |
| 2 | 2 | **astra** | Astra: see what your classroom is really doing, in one conversation |
| 3 | 3 | **voice-onboarding** | Set up Montree by talking — no hours of typing |
| 4 | 4 | **curriculum** | Per-child curriculum that plans itself — no paper |
| 5 | 5 | **library** | Printable Montessori materials, generated in seconds |
| 6 | 6 | **communication** | Every parent & teacher message in one thread |
| 7 | 7 | **appointments** | Parent meetings & tours booked without the back-and-forth |
| 8 | 8 | **multilingual** | Speaks every family's language, automatically |

> Best windows (Beijing time, US-primary audience): **Tue–Thu ~21:00–00:00** and **Sat ~08:00–10:00**. Always native upload (no other platform's watermark), captions on, reply to comments in the first hour.

---

# PER-VIDEO COPY

Each block = ready to paste. Keep the hook as line 1.

---

## VIDEO 1 — GURU
*An AI guru that knows each child individually — "one child, one puzzle" — trained on your real classroom records.*
...
## VIDEO 2 — ASTRA
*Astra, the AI chief-of-staff: ask what your classroom is really doing and get the answer in one conversation — instead of a dozen walk-arounds.*
...
## VIDEO 3 — VOICE ONBOARDING
*Set Montree up by talking. No hours of typing — speak, and it's logged.*
...
## VIDEO 4 — CURRICULUM
*For every child, Montree sees where they are and plans the next step — no planning on paper.*
...
## VIDEO 5 — LIBRARY (MATERIALS)
*Three-part cards, picture bingo and more — generated, printable, themed to your room. Your prep time, handed back.*
...
*Email, WhatsApp, sticky notes — teachers and parents in one place, pick up exactly where you left off.*
...
## VIDEO 7 — APPOINTMENTS
*Parent meetings and school tours booked without the email back-and-forth.*
...
## VIDEO 8 — MULTILINGUAL
*Speaks every family's language, automatically — no family left out.*
