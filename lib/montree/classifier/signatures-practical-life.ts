  ...
  // --- Sewing and Needlework ---
  {
    ...
    confusion_pairs: [
      ...
      },
      {
        ...
        reason: 'Both involve colorful beads — CLIP confuses any bead activity with math bead works',
        differentiation: 'Threading Beads is PRACTICAL LIFE: child threads LOOSE BEADS one-by-one onto a STRING/CORD from a CONTAINER, beads are LARGE (0.5-1 inch), RANDOM colors. Short Bead Stair is MATHEMATICS: FIXED BEAD BARS already permanently wired together in a STAIRCASE PATTERN (1-9), each bar a SPECIFIC COLOR matching Montessori color coding',
      },
    ],
    negative_descriptions: [
      ...
      'NOT Short Bead Stair — threading beads are LOOSE individual beads being strung onto cord, NOT pre-made bead bars in a staircase',
      'NOT Bead Cabinet or any math bead work — this is a PRACTICAL LIFE fine motor activity with a STRING and CONTAINER of loose beads',
      'NOT perler beads or craft beads on a pegboard',
    ],
    difficulty: 'easy',
  },
  {
