...
export const CULTURAL_SIGNATURES: WorkSignature[] = [
  ...
  // ==================== MUSIC ====================
  {
    ...
    confusion_pairs: [],
    negative_descriptions: [
      'NOT rhythm instruments (singing uses VOICE not percussion instruments)',
      'NOT music appreciation (active singing not passive listening)',
      'NOT movement to music (stationary singing not full-body movement)',
    ],
    difficulty: 'easy'
  },

  {
    ...
    confusion_pairs: [],
    negative_descriptions: [
      'NOT Montessori bells (handheld percussion instruments not mounted tuned bells)',
      'NOT singing (striking instruments not using voice)',
      'NOT movement to music (seated percussion play not full-body dancing)',
    ],
    difficulty: 'easy'
  },

  {
    ...
    confusion_pairs: [],
    negative_descriptions: [
      'NOT rhythm instruments (full-body dancing not seated instrument play)',
      'NOT singing (physical movement expression not vocal production)',
      'NOT walking the line (free creative movement not structured balance walking)',
    ],
    difficulty: 'easy'
  },

  {
    ...
    confusion_pairs: [],
    negative_descriptions: [
      'NOT rhythm instruments (mounted tuned bells on wooden stand not handheld percussion)',
      'NOT singing (striking bells with mallets not vocal production)',
      'NOT color tablets (bells are COLOR-CODED METAL on WOODEN STAND not flat painted tablets)',
    ],
    difficulty: 'medium'
  },

  {
    ...
    confusion_pairs: [],
    negative_descriptions: [
      'NOT rhythm instruments (passive listening not active instrument play)',
      'NOT singing (listening and studying not vocal production)',
      'NOT Montessori bells (studying composers and orchestral music not pitch matching with bells)',
    ],
    difficulty: 'medium'
  }
];
