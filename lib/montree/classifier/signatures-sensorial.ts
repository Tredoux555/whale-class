...
export const SENSORIAL_SIGNATURES: WorkSignature[] = [
...

  {
    ...
    confusion_pairs: [
      { work_key: 'se_cylinder_block_2', reason: 'Similar wooden blocks with cylindrical holes and wooden knobs', differentiation: 'Block 1 varies DIAMETER ONLY, Block 2 varies diameter AND HEIGHT (inverted relationship)' },
      { work_key: 'se_cylinder_block_3', reason: 'Wooden blocks with knobbed cylinders in holes', differentiation: 'Block 1 diameter-only varies, Block 3 diameter and HEIGHT (proportional, not inverted)' },
      { work_key: 'se_knobless_cylinders', reason: 'Wooden cylinders with similar size variations', differentiation: 'Cylinder Block 1 has KNOBS and mounted in BLOCK, Knobless has NO KNOBS and FREE-STANDING in TRAYS' },
    ],
    negative_descriptions: [
      'NOT free-standing cylinders without knobs',
      'NOT cylinders with inverted height-diameter relationship',
      'NOT color-coded tray system',
    ],
    difficulty: 'medium',
  },

  {
    ...
    confusion_pairs: [
      { work_key: 'se_cylinder_block_1', reason: 'Wooden blocks with cylindrical holes and wooden knobs', differentiation: 'Block 2 height-diameter INVERTED (small thin tall, large thick short), Block 1 diameter-only varies' },
      { work_key: 'se_cylinder_block_3', reason: 'Wooden blocks with varying diameter and height cylinders', differentiation: 'Block 2 height-diameter INVERTED, Block 3 height-diameter PROPORTIONAL (both increase together)' },
      { work_key: 'se_cylinder_block_4', reason: 'Wooden block with multiple cylinder sizes', differentiation: 'Block 2 cylinders in LINEAR ROW, Block 4 cylinders in CIRCULAR/SPIRAL pattern (no line)' },
      { work_key: 'se_knobless_cylinders', reason: 'Cylinders with size variations and knobs', differentiation: 'Block 2 has KNOBS and BLOCK-MOUNTED, Knobless has NO KNOBS and FREE-STANDING' },
    ],
    negative_descriptions: [
      'NOT proportional height-diameter scaling',
      'NOT non-linear hole arrangement',
      'NOT free-standing cylinders',
    ],
    difficulty: 'hard',
  },

  {
    ...
    confusion_pairs: [
      { work_key: 'se_cylinder_block_1', reason: 'Wooden blocks with cylindrical knobbed cylinders', differentiation: 'Block 3 diameter and HEIGHT both INCREASE (proportional staircase), Block 1 diameter-only varies' },
      { work_key: 'se_cylinder_block_2', reason: 'Wooden blocks with varying diameter and height', differentiation: 'Block 3 height-diameter PROPORTIONAL, Block 2 height-diameter INVERTED (opposite relationship)' },
      { work_key: 'se_cylinder_block_4', reason: 'Wooden block with multiple sized cylinders', differentiation: 'Block 3 cylinders in LINEAR LEFT-TO-RIGHT ROW with staircase profile, Block 4 CIRCULAR/SPIRAL non-linear' },
      { work_key: 'se_knobless_cylinders', reason: 'Cylinders with size variations and wooden knobs', differentiation: 'Block 3 has KNOBS and MOUNTED IN BLOCK, Knobless NO KNOBS and FREE-STANDING' },
    ],
    negative_descriptions: [
      'NOT diameter-only variation',
      'NOT inverted height-diameter relationship',
      'NOT circular or non-linear hole arrangement',
    ],
    difficulty: 'hard',
  },

  {
    ...
    confusion_pairs: [
      { work_key: 'se_cylinder_block_1', reason: 'Wooden blocks with cylindrical holes', differentiation: 'Block 4 holes in CIRCULAR/SPIRAL pattern (no line), Block 1 holes in LINEAR row' },
      { work_key: 'se_cylinder_block_2', reason: 'Wooden blocks with multiple sized cylinders', differentiation: 'Block 4 has NON-LINEAR spatial arrangement, Block 2 cylinders in LINEAR row' },
      { work_key: 'se_cylinder_block_3', reason: 'Wooden blocks with height and diameter variations', differentiation: 'Block 4 CIRCULAR/SPIRAL pattern no linear arrangement, Block 3 LINEAR ROW with staircase' },
      { work_key: 'se_knobless_cylinders', reason: 'Cylinders with multiple size dimensions', differentiation: 'Block 4 has KNOBS and BLOCK-MOUNTED, Knobless NO KNOBS and FREE-STANDING in TRAYS' },
    ],
    negative_descriptions: [
      'NOT linear left-to-right arrangement',
      'NOT knobless cylinders',
      'NOT free-standing in color-coded trays',
    ],
    difficulty: 'hard',
  },

  {
    ...
    confusion_pairs: [],
    negative_descriptions: [
      'NOT individual cylinder block sets',
      'NOT knobless cylinders in separate trays',
      'NOT single hole arrangement pattern',
    ],
    difficulty: 'hard',
  },

  {
    ...
    confusion_pairs: [
      { work_key: 'se_brown_stair', reason: 'Both wooden stacking materials with size progression', differentiation: 'Pink Tower PINK CUBES form PYRAMID, Brown Stair BROWN RECTANGULAR PRISMS form STAIRCASE' },
    ],
    negative_descriptions: [
      'NOT brown staircase',
      'NOT rectangular prisms',
      'NOT stair-step profile',
    ],
    difficulty: 'easy',
  },

  {
    ...
    confusion_pairs: [
      { work_key: 'se_pink_tower', reason: 'Both wooden stacking materials with size progression', differentiation: 'Brown Stair BROWN RECTANGULAR PRISMS varying BASE AREA with STAIRCASE profile, Pink Tower PINK CUBES form PYRAMID' },
    ],
    negative_descriptions: [
      'NOT pink cubes',
      'NOT cube shapes',
      'NOT pyramid stacking form',
    ],
    difficulty: 'easy',
  },

  {
    ...
    confusion_pairs: [],
    negative_descriptions: [
      'NOT color boxes (which vary color, not length)',
      'NOT number rods with alternating segments',
      'NOT cylinders with size-dependent height relationships',
    ],
    difficulty: 'easy',
  },

  {
    ...
    confusion_pairs: [
      { work_key: 'se_cylinder_block_1', reason: 'Wooden cylinders with size variations', differentiation: 'Knobless NO KNOBS and FREE-STANDING in COLOR-CODED TRAYS, Block 1 HAS KNOBS and MOUNTED in BLOCK' },
      { work_key: 'se_cylinder_block_2', reason: 'Multiple sized wooden cylinders', differentiation: 'Knobless FREE-STANDING in FOUR SEPARATE TRAYS, Block 2 KNOBBED and BLOCK-MOUNTED' },
      { work_key: 'se_cylinder_block_3', reason: 'Cylinders with height and diameter variation', differentiation: 'Knobless NO KNOBS and FOUR COLOR TRAYS, Block 3 WOODEN KNOBS and SINGLE BLOCK' },
      { work_key: 'se_cylinder_block_4', reason: 'Multiple cylinder sizes', differentiation: 'Knobless FREE-STANDING cylinders in TRAYS, Block 4 KNOBBED cylinders BLOCK-MOUNTED' },
    ],
    negative_descriptions: [
      'NOT wooden knobs on cylinders',
      'NOT block-mounted cylinders',
      'NOT single wooden block container',
    ],
    difficulty: 'hard',
  },
...

  {
    ...
    confusion_pairs: [
      { work_key: 'se_color_box_2', reason: 'Both contain painted wooden color tablets', differentiation: 'Box 1 THREE PRIMARY COLORS ONLY (red/blue/yellow), Box 2 SIX COLORS (primary + secondary)' },
      { work_key: 'se_color_box_3', reason: 'Both have color-matching tablets', differentiation: 'Box 1 three PRIMARY colors, Box 3 eleven COLOR FAMILIES with SHADE GRADATIONS' },
    ],
    negative_descriptions: [
      'NOT secondary colors (orange, green, purple)',
      'NOT multiple shade gradations',
      'NOT 22+ tablets',
    ],
    difficulty: 'easy',
  },

  {
    ...
    confusion_pairs: [
      { work_key: 'se_color_box_1', reason: 'Both contain painted wooden color tablets', differentiation: 'Box 2 SIX COLORS (primary + SECONDARY), Box 1 THREE PRIMARY COLORS ONLY' },
      { work_key: 'se_color_box_3', reason: 'Both have multiple color tablets', differentiation: 'Box 2 six solid single-HUE colors, Box 3 eleven COLOR FAMILIES with NINE SHADE GRADATIONS each' },
    ],
    negative_descriptions: [
      'NOT primary colors only',
      'NOT 99 tablets',
      'NOT subtle shade gradations within families',
    ],
    difficulty: 'medium',
  },

  {
    ...
    confusion_pairs: [
      { work_key: 'se_color_box_1', reason: 'Both have painted wooden color tablets', differentiation: 'Box 3 ELEVEN COLOR FAMILIES with NINE SHADE GRADATIONS each (99 tablets), Box 1 THREE PRIMARY COLORS' },
      { work_key: 'se_color_box_2', reason: 'Both contain multiple colored tablets', differentiation: 'Box 3 ELEVEN FAMILIES with SHADE GRADATIONS (99 tablets), Box 2 six solid single-HUE colors (22 tablets)' },
    ],
    negative_descriptions: [
      'NOT primary colors only',
      'NOT solid single-hue colors',
      'NOT six color families',
    ],
    difficulty: 'hard',
  },
...

  {
    ...
    confusion_pairs: [
      { work_key: 'se_geometric_solids', reason: 'Both contain geometric shapes', differentiation: 'Cabinet flat METAL FRAME INSETS for TRACING (2D stencils), Solids chunky 3D WOODEN BLOCKS for ROLLING and STACKING' },
    ],
    negative_descriptions: [
      'NOT 3D wooden geometric blocks',
      'NOT rolling and stacking activities',
      'NOT solid wooden forms',
    ],
    difficulty: 'medium',
  },

  {
    ...
    confusion_pairs: [
      { work_key: 'se_geometric_cabinet', reason: 'Both contain geometric shapes', differentiation: 'Solids CHUNKY 3D WOODEN BLOCKS for kinesthetic exploration, Cabinet FLAT METAL FRAME INSETS for tracing' },
    ],
    negative_descriptions: [
      'NOT flat metal frame insets',
      'NOT tracing activities',
      'NOT wooden cabinet with drawers',
    ],
    difficulty: 'medium',
  },
...

  {
    ...
    confusion_pairs: [
      { work_key: 'se_constructive_triangles_tri', reason: 'Both contain wooden triangles for construction', differentiation: 'Rectangle RIGHT TRIANGLES (90-45-45) forming RECTANGLES/SQUARES, Equilateral EQUILATERAL TRIANGLES (60-60-60) forming COMPLEX PATTERNS' },
      { work_key: 'se_constructive_triangles_large_hex', reason: 'Both are wooden triangle construction sets', differentiation: 'Rectangle RED right triangles SIMPLE ASSEMBLY, Large Hex BLUE triangles forming SPECIFIC HEXAGON TARGET' },
      { work_key: 'se_constructive_triangles_small_hex', reason: 'Both have wooden triangle pieces', differentiation: 'Rectangle LARGE RED pieces, Small Hex TINY GREEN pieces in HEXAGON pattern' },
      { work_key: 'se_constructive_triangles_blue', reason: 'Both wooden triangle construction materials', differentiation: 'Rectangle RED right triangles only, Blue box MIXED isosceles and right TRIANGLES VARIED' },
    ],
    negative_descriptions: [
      'NOT equilateral triangles',
      'NOT hexagon-forming pattern',
      'NOT mixed triangle types',
    ],
    difficulty: 'medium',
  },

  {
    ...
    confusion_pairs: [
      { work_key: 'se_constructive_triangles_rect', reason: 'Both contain wooden triangles for assembly', differentiation: 'Equilateral YELLOW 60-60-60 degree triangles forming COMPLEX patterns, Rectangle RED 90-45-45 degree RIGHT triangles forming RECTANGLES' },
      { work_key: 'se_constructive_triangles_large_hex', reason: 'Both have wooden triangle pieces', differentiation: 'Equilateral YELLOW exploratory compositions, Large Hex BLUE triangles targeting specific HEXAGON FORM' },
      { work_key: 'se_constructive_triangles_small_hex', reason: 'Both construct geometric patterns', differentiation: 'Equilateral YELLOW larger pieces OPEN-ENDED, Small Hex GREEN tiny pieces HEXAGON TARGET' },
    ],
    negative_descriptions: [
      'NOT right triangles',
      'NOT hexagon-forming pattern',
...

  {
    ...
    confusion_pairs: [
      { work_key: 'se_constructive_triangles_rect', reason: 'Both have wooden triangle construction materials', differentiation: 'Large Hex BLUE triangles forming specific LARGE HEXAGON, Rectangle RED right triangles forming RECTANGLES' },
      { work_key: 'se_constructive_triangles_tri', reason: 'Both wooden triangle sets for assembly', differentiation: 'Large Hex BLUE SPECIFIC HEXAGON target, Equilateral YELLOW EXPLORATORY COMPOSITIONS' },
      { work_key: 'se_constructive_triangles_small_hex', reason: 'Both form hexagon patterns', differentiation: 'Large Hex 15-25 LARGER PIECES, Small Hex 20-30 TINY DELICATE pieces' },
    ],
    negative_descriptions: [
      'NOT red right triangles',
      'NOT yellow equilateral triangles',
      'NOT tiny delicate pieces',
    ],
    difficulty: 'hard',
  },

  {
    ...
    confusion_pairs: [
      { work_key: 'se_constructive_triangles_rect', reason: 'Both contain wooden triangle pieces', differentiation: 'Small Hex GREEN tiny delicate pieces HEXAGON target, Rectangle RED right triangles forming RECTANGLES' },
      { work_key: 'se_constructive_triangles_tri', reason: 'Both are wooden triangle construction sets', differentiation: 'Small Hex GREEN TINY 20-30 pieces HEXAGON TARGET, Equilateral YELLOW LARGER pieces OPEN composition' },
      { work_key: 'se_constructive_triangles_large_hex', reason: 'Both form hexagon patterns with triangles', differentiation: 'Small Hex GREEN 20-30 TINY DELICATE pieces, Large Hex BLUE 15-25 LARGER pieces' },
    ],
    negative_descriptions: [
      'NOT large pieces',
      'NOT red or yellow or blue',
      'NOT right triangles only',
    ],
    difficulty: 'hard',
  },

  {
    ...
    confusion_pairs: [
      { work_key: 'se_constructive_triangles_rect', reason: 'Both contain wooden triangles', differentiation: 'Blue box MIXED isosceles and RIGHT triangles exploratory, Rectangle RED RIGHT triangles only forming RECTANGLES' },
      { work_key: 'se_constructive_triangles_tri', reason: 'Both are triangle construction sets', differentiation: 'Blue box MIXED triangle TYPES exploratory composition, Equilateral YELLOW equilateral triangles forming COMPLEX patterns' },
      { work_key: 'se_constructive_triangles_large_hex', reason: 'Both have wooden triangle pieces', differentiation: 'Blue box 12-18 MIXED TYPES open-ended, Large Hex 15-25 equilateral forming HEXAGON TARGET' },
      { work_key: 'se_constructive_triangles_small_hex', reason: 'Both triangle construction materials', differentiation: 'Blue box MIXED triangle TYPES 12-18 pieces, Small Hex TINY pieces forming HEXAGON' },
    ],
    negative_descriptions: [
      'NOT all same triangle type',
      'NOT hexagon-forming pattern',
      'NOT constrained goal-oriented assembly',
    ],
    difficulty: 'hard',
  },
...

  {
    ...
    confusion_pairs: [
      { work_key: 'se_trinomial_cube', reason: 'Both are disassembling/reassembling cube puzzles', differentiation: 'Binomial EIGHT pieces (2×2×2 = 2 cubed), Trinomial TWENTY-SEVEN pieces (3×3×3 = 3 cubed, MUCH MORE COMPLEX)' },
    ],
    negative_descriptions: [
      'NOT 27 pieces',
      'NOT four colors (red/blue/yellow/natural)',
      'NOT complex 3×3×3 arrangement',
    ],
    difficulty: 'medium',
  },

  {
    ...
    confusion_pairs: [
      { work_key: 'se_binomial_cube', reason: 'Both are disassembling/reassembling cube puzzles', differentiation: 'Trinomial TWENTY-SEVEN pieces (3×3×3 COMPLEX), Binomial EIGHT pieces (2×2×2 SIMPLE)' },
    ],
    negative_descriptions: [
      'NOT eight pieces',
      'NOT 2×2×2 arrangement',
      'NOT three colors only',
    ],
    difficulty: 'hard',
  },
...

  {
    ...
    confusion_pairs: [
      { work_key: 'se_touch_tablets', reason: 'Both texture discrimination work', differentiation: 'Touch Boards LARGE wooden BOARDS with coarse sandpaper one side, Touch Tablets SMALL tablets with MOUNTED VARIED MATERIALS (silk, velvet, cloth)' },
    ],
    negative_descriptions: [
      'NOT small mounted fabric materials',
      'NOT varied textile types',
      'NOT portable card-backed swatches',
    ],
    difficulty: 'easy',
  },

  {
    ...
    confusion_pairs: [
      { work_key: 'se_touch_boards', reason: 'Both texture discrimination work', differentiation: 'Touch Tablets SMALL tablets with MOUNTED VARIED MATERIALS (silk, velvet, cloth), Touch Boards LARGE wooden BOARDS with SANDPAPER one side' },
    ],
    negative_descriptions: [
      'NOT large wooden boards',
      'NOT coarse sandpaper primary material',
      'NOT limited to rough-smooth contrast',
    ],
    difficulty: 'medium',
  },
...

  {
    ...
    confusion_pairs: [],
    negative_descriptions: [
      'NOT taste-based discrimination',
      'NOT sound-based work',
      'NOT temperature-based bottles',
    ],
    difficulty: 'medium',
  },
...

  {
    ...
    confusion_pairs: [],
    negative_descriptions: [
      'NOT smell-based discrimination',
      'NOT temperature-based',
      'NOT sound-based work',
    ],
    difficulty: 'medium',
  },
...

  {
    ...
    confusion_pairs: [],
    negative_descriptions: [
      'NOT tuned musical bells',
      'NOT open containers',
      'NOT clear distinct pitches',
    ],
    difficulty: 'hard',
  },

  {
    ...
    confusion_pairs: [],
    negative_descriptions: [
      'NOT sealed rattle boxes',
      'NOT mixed varied sounds',
      'NOT pure tones without pitch structure',
    ],
    difficulty: 'medium',
  },
...

  {
    ...
    confusion_pairs: [],
    negative_descriptions: [
      'NOT grain or homogeneous material sorting',
      'NOT single material type only',
      'NOT limited shape variety',
    ],
    difficulty: 'hard',
  },

  {
    ...
    confusion_pairs: [],
    negative_descriptions: [
      'NOT diverse everyday objects and natural materials',
      'NOT open-ended multiple classification systems',
      'NOT buttons, beads, shells, or found objects',
    ],
    difficulty: 'medium',
  },
...

  {
    ...
    confusion_pairs: [],
    negative_descriptions: [
      'NOT temperature-based discrimination',
      'NOT color or texture variation',
      'NOT visible weight differences',
    ],
    difficulty: 'hard',
  },
...

  {
    ...
    confusion_pairs: [],
    negative_descriptions: [
      'NOT weight-based discrimination',
      'NOT obvious visible material differences',
      'NOT water-filled bottles with temperature extremes',
    ],
    difficulty: 'hard',
  },

  {
    ...
    confusion_pairs: [],
    negative_descriptions: [
      'NOT hidden inlay material differences',
      'NOT subtle thermal conductivity variations',
      'NOT extreme temperature differences requiring care',
    ],
    difficulty: 'medium',
  },
...

  {
    ...
    confusion_pairs: [],
    negative_descriptions: [
      'NOT homogeneous grain sorting',
      'NOT geometric shape overlaying',
      'NOT single material type focus',
    ],
    difficulty: 'medium',
  },

  {
    ...
    confusion_pairs: [],
    negative_descriptions: [
      'NOT 3D geometric solids',
      'NOT mixed diverse objects',
      'NOT texture or material discrimination',
    ],
    difficulty: 'medium',
  },

  {
    ...
    confusion_pairs: [
      { work_key: 'se_color_box_1', reason: 'Both have color swatches and matching pairs', differentiation: 'Fabric Matching SOFT CLOTH SWATCHES with TEXTURE focus, Color Box 1 RIGID PAINTED WOOD TABLETS with COLOR focus' },
      { work_key: 'se_color_box_2', reason: 'Both have material swatches in pairs', differentiation: 'Fabric Matching SOFT TEXTILES (silk/velvet/linen), Color Box 2 RIGID PAINTED WOOD with color hues' },
      { work_key: 'se_color_box_3', reason: 'Both have matching pairs of materials', differentiation: 'Fabric Matching CLOTH MATERIALS with WEAVE variations, Color Box 3 PAINTED WOOD with SHADE GRADATIONS' },
    ],
    negative_descriptions: [
      'NOT rigid painted wood tablets',
      'NOT color matching primary task',
      'NOT shade gradation work',
    ],
    difficulty: 'medium',
  },
];
