...
export const COMMAND_SENTENCE_TEMPLATES: CommandSentenceTemplate[] = [
  ...
  { pattern: 'Put the {word} on the {word2}.', requiredWords: ['put'], phase: 'pink1' },
  ...
  { pattern: 'Dip the {word} in the {word2}.', requiredWords: ['dip'], phase: 'pink2' },
  { pattern: 'Set the {word} on the {word2}.', requiredWords: ['set'], phase: 'pink2' },
  // Blue templates
  { pattern: 'Grab the {word} and {word2}.', requiredWords: ['grab'], phase: 'blue1' },
  { pattern: 'Clap and then touch the {word}.', requiredWords: ['clap'], phase: 'blue1' },
  { pattern: 'Step on the {word} and {word2}.', requiredWords: ['step'], phase: 'blue1' },
  { pattern: 'Skip to the {word}.', requiredWords: ['skip'], phase: 'blue1' },
  { pattern: 'Jump to the {word} and {word2}.', requiredWords: ['jump'], phase: 'blue2' },
  ...
  { pattern: 'Kick the {word} to the {word2}.', requiredWords: ['kick'], phase: 'blue3' },
  // Green templates
  { pattern: 'Push the {word} to the {word2}.', requiredWords: ['push'], phase: 'green1' },
  { pattern: 'Chop the {word} with care.', requiredWords: ['chop'], phase: 'green1' },
  { pattern: 'Take the {word} to the {word2}.', requiredWords: ['take'], phase: 'green2' },
  { pattern: 'Ride the {word} to the {word2}.', requiredWords: ['ride'], phase: 'green2' },
  { pattern: 'Read the {word} by the {word2}.', requiredWords: ['read'], phase: 'green2' },
  { pattern: 'Write the {word} on the {word2}.', requiredWords: ['write'], phase: 'green3' },
