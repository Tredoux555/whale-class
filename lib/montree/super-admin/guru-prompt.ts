...
const DATABASE_SCHEMA = {
  ...
  montree_guru_interactions: 'id, child_id, classroom_id, teacher_id, question_type, model_used, processing_time_ms, locale, asked_at',
  ...
  montree_behavioral_observations: 'id, child_id, classroom_id, behavior_description, antecedent, consequence, behavior_function, time_of_day, activity_during, observed_at, observed_by',
