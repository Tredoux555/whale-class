// lib/cms/i18n/dictionaries/sw.ts
// Swahili — TYPED STUB. Re-exports English verbatim so the locale is selectable,
...
// key-for-key against dictionaries/en.ts, then flip LOCALE_META['sw'].status
