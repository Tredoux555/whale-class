// lib/cms/i18n/dictionaries/es.ts
// Spanish — TYPED STUB. Re-exports English verbatim so the locale is selectable,
...
// key-for-key against dictionaries/en.ts, then flip LOCALE_META['es'].status
