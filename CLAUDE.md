...
**Canonical handoff:** `docs/handoffs/SESSION_LYFCOACH_UI_FIXES_JUN24.md`. **2 commits on `main`, pushed + Railway auto-deploying:** `b703518d` (Fix 1) · `8c36b299` (Fix 2). **🚨 Migration 272 PENDING Supabase run** — Fix 2 banner is inert until then.
