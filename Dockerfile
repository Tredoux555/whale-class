...
RUN --mount=type=cache,id=s/7a625d48-3bc5-48c3-b4e9-369b6ddd6475-/root/.npm,target=/root/.npm \
...
RUN --mount=type=cache,id=s/7a625d48-3bc5-48c3-b4e9-369b6ddd6475-/app/.next/cache,target=/app/.next/cache \
    npm run build
