...
BEGIN
  ...
  FROM (VALUES
    ...
    ('dp:p:1', 'p Dark Phonics work 1', 'Characters — The ___ Spat!', 41),
    ('dp:p:2', 'p Dark Phonics work 2', 'Picture match — The ___ Spat!', 42),
    ('dp:p:3', 'p Dark Phonics work 3', 'Sentence & picture match — The ___ Spat!', 43),
    ('dp:p:4', 'p Dark Phonics work 4', 'Sentence builder (guided) — The ___ Spat!', 44),
    ('dp:p:5', 'p Dark Phonics work 5', 'Sentence builder (free) — The ___ Spat!', 45),
