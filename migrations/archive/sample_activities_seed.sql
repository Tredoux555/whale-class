...
INSERT INTO activities (name, area, skill_level, age_min, age_max, instructions, learning_goals, materials, prerequisites) VALUES
...
('Sandpaper Letters', 'language', 1, 3.0, 5.0,
...
('Moveable Alphabet', 'language', 3, 4.0, 6.0,
...
('Parts of a Plant', 'cultural', 2, 3.5, 5.5,
...
('World Map Puzzle', 'cultural', 3, 4.0, 6.0,
