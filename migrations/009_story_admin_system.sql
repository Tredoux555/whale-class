-- Story Admin System - Login Tracking & Message History
...
-- Create a scheduled job to run expiry check (runs every hour)
-- Note: This requires pg_cron extension in Supabase
-- You can also trigger this manually or via API
...
-- Create Supabase Storage bucket for story media uploads
